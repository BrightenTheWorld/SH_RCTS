...
TS = Tk()
TS.title("High Amplitude TS test")

# TS.geometry("640x480+300+100")  # 가로 x 세로 + x좌표 + y좌표
TS.geometry("620x960+1285+10")
# x(너비), y(높이) 값 변경 불가 (창 크기 변경 불가)
TS.resizable(True, True)  
...
file.add_separator()
file.add_command(label ='Exit', command = TS.destroy)
